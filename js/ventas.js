...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    if (typeof Chart !== "undefined") {
        ...
        tooltips: {
          ...
          custom: function (tooltipModel) {
            if (tooltipModel && tooltipModel.dataPoints) {
              ...
              $textContainer.find(".value").html("Unidades " + $.fn.addCommas(yLabel));
      ...
      if (document.getElementById("areaChart2")) {
        var areaChart2 = document.getElementById("areaChart2").getContext("2d");
        var myChart2 = new Chart(areaChart2, {
          type: "LineWithShadow",
          options: {
            plugins: {
              datalabels: {
      ...
      if (document.getElementById("areaChart3")) {
        var areaChart3 = document.getElementById("areaChart3").getContext("2d");
        var myChart3 = new Chart(areaChart3, {
          type: "LineWithShadow",
          options: {
            plugins: {
              datalabels: {
      ...
      if (document.getElementById("areaChart4")) {
        var areaChart4 = document.getElementById("areaChart4").getContext("2d");
        var myChart4 = new Chart(areaChart4, {
          type: "LineWithShadow",
          options: {
            plugins: {
              datalabels: {
          ...
          data: {
            ...
            datasets: [
              {
                label: "Autos",
                data: [54, 63, 60,54, 63, 60,54, 63, 60,54, 63, 60],
                borderColor: themeColor1,
                pointBackgroundColor: foregroundColor,
                pointBorderColor: themeColor1,
                pointHoverBackgroundColor: themeColor1,
      ...
      if (document.getElementById("areaChart_cvp3")) {
        var areaChart_cvp3 = document.getElementById("areaChart_cvp3").getContext("2d");
        var myChart5 = new Chart(areaChart_cvp3, {
          type: "LineWithShadow",
          options: {
            plugins: {
              datalabels: {
      ...
      if (document.getElementById("areaChart_cvp2")) {
        var areaChart_cvp2 = document.getElementById("areaChart_cvp2").getContext("2d");
        var myChart6 = new Chart(areaChart_cvp2, {
          type: "LineWithShadow",
          options: {
            plugins: {
              datalabels: {
      ...
      if (document.getElementById("areaChart_cvp1")) {
        var areaChart_cvp2 = document.getElementById("areaChart_cvp1").getContext("2d");
        var myChart7 = new Chart(areaChart_cvp1, {
          type: "LineWithShadow",
          options: {
            plugins: {
              datalabels: {
      ...
      if (document.getElementById("categoryChart")) {
        ...
        var myDoughnutChart = new Chart(categoryChart, {
          ...
          data: {
            labels: ["Estado", "Brecha del Objetivo"],
            datasets: [
              {
                label: "",
    ...
    if ($().DataTable) {
      ...
      $(".data-table-standard2").DataTable({
        bLengthChange: false,
        searching: false,
        destroy: true,
        info: false,
      ...
      $(".data-table-feature-inventario").DataTable({
        sDom: '<"row view-filter"<"col-sm-12"<"float-right"l><"float-left"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
        "columns": [
          { "data": "name" },
          { "data": "position" },
