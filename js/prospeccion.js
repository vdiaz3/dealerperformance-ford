...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    if ($().DataTable) {
      ...
      // Datatable with rows
      var $dataTableRows = $("#tasa_conversion_clientes_mes").DataTable({
        bLengthChange: false,
        buttons: [
          'copy',
          'excel',
      ...
      var $dataTableRows2 = $("#tasa_conversion_clientes_ano").DataTable({
        bLengthChange: false,
        buttons: [
          'copy',
          'excel',
      ...
      $("#dataTablesCopy2").on("click", function(event) {
        event.preventDefault();
        $dataTableRows2.buttons(0).trigger();
      });

      $("#dataTablesExcel2").on("click", function(event) {
        event.preventDefault();
        $dataTableRows2.buttons(1).trigger();
      });
      

      $("#dataTablesCsv2").on("click", function(event) {
        event.preventDefault();
        $dataTableRows2.buttons(2).trigger();
      });
      
    

      $("#dataTablesPdf2").on("click", function(event) {
        event.preventDefault();
        $dataTableRows2.buttons(3).trigger();
      });
      ...
      $("#searchDatatable2").on("keyup", function (event) {
        $dataTableRows2.search($(this).val()).draw();
      });
